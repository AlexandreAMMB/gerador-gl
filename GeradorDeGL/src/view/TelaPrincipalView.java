    ...
    class MyHighlighterPainter extends DefaultHighlighter.DefaultHighlightPainter{
        ...
        public void hightLight(String pattern){
            ...
            try{
                ...
                if(counter == 0) {
                    JOptionPane.showMessageDialog(null, "Não foi encontrada nenhuma correlação para sua busca!");
                } else {
                    JOptionPane.showMessageDialog(null, "Foram encontradas " + counter + " correlações!");
                }
            }
            catch(Exception e){
